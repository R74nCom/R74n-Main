...
"taking a break",
"swimming",
"climbing {{c|wall|leg|pant leg|furniture|rock|hill|tree|blade of grass|fence|foot|shoe|flower stem|pole|stair|fence post|car|bench|door|window|chair|stone}}",
"staying still",
"escaping ant trap",
"investigating",
...
"breaking down food",
"death spiraling",
"carrying {{c|carcass|crumb|leaf|captive|sand|seed|pebble|pollen|exoskeleton|insect head|insect leg|insect wing|insect antenna|insect abdomen|snail shell|piece of meat|piece of fruit|piece of plant|sugar|nectar|dirt|anthill clay}}",
"alerting the colony",
...
"dissection",
"pressure washer",
"drowning in {{c|water bottle|sewer|soda can|puddle|lake|fountain|pool|birdbath|pilk}}",
"cat",
"dog",
"bee sting",
"snake",
