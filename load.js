...
if (window.navigator) {
	...
	if (navigator.userAgent) {
		...
		if (agent.match(/chrome/)) R74n.state.browser = "chrome";
		else if (agent.match(/safari/) && navigator.vendor && navigator.vendor.match(/Apple Computer/)) R74n.state.browser = "safari";
		else if (agent.match(/firefox/)) R74n.state.browser = "firefox";
	}
}
